...
vim.keymap.set('t', '<C-q>', '<cmd>bd!<CR>', { desc = 'Exit terminal session' })
vim.keymap.set('n', '<C-q>', '<cmd>bd!<CR>', { desc = 'Delete(unload) current buffer' })
...
-- auto import go dependencies (handled by plugins)
